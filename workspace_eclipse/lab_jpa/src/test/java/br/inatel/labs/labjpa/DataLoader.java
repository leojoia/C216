...
class DataLoader {
	...
	void load() {
		...
		NotaCompraItem i2_1 = new NotaCompraItem(nc2, p4, new BigDecimal("400.00"),2);
		NotaCompraItem i2_2 = new NotaCompraItem(nc2, p2, new BigDecimal("1000.00"),1);
		NotaCompraItem i2_3 = new NotaCompraItem(nc2, p5, new BigDecimal("700.00"),3);
